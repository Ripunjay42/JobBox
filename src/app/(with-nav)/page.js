          ...
          <div className="md:w-2/3 border-2 border-black dark:border-gray-700 p-4 bg-white dark:bg-gray-900 shadow-lg">
            ...
            <div className="flex justify-between mt-4">
              ...
              <button 
                ...
                className={`px-3 py-1 text-sm font-bold rounded underline ${currentPage >= totalPages ? 'bg-gray-300 dark:bg-gray-700 cursor-not-allowed' : 'bg-indigo-500 text-white hover:bg-indigo-600 dark:bg-indigo-700 dark:hover:bg-indigo-800'}`}
              >
                next
              </button>
            </div>
